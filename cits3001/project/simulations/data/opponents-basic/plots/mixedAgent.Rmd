...
all.plots = annotate_figure(
  all.plots,
  top = text_grob("Win Ratio of Mixed Agents with 'Basic Agent' Opponents",
                  size=18, face="bold"),
