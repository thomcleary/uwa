...
class RandomAgent(Agent):
    ...
    def __init__(self, name='Rando'):
        ...
        # These are assigned in self.new_game()
        self.number_of_players = None
        self.player_number     = None
        self.spy_list          = None

        # objects to retain win percentage data for future analysis
        self.num_spy_games    = 0
        self.spy_wins         = 0

        self.num_resistance_games = 0
        self.resistance_wins      = 0

        self.spy_win_ratios        = {}
        self.resistance_win_ratios = {}
        self.win_ratios            = {}
    ...
    def update_win_ratios(self):
        ...
        '''
        if self.is_spy():
            self.spy_win_ratios[self.num_spy_games-1] = self.spy_wins / self.num_spy_games

        else:
            self.resistance_win_ratios[self.num_resistance_games-1] = (
                self.resistance_wins / self.num_resistance_games
            )

        self.win_ratios[self.num_spy_games + self.num_resistance_games-1] = ( 
